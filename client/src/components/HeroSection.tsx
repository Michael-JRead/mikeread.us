  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div 
          className="absolute top-0 right-0 w-96 h-96 bg-blue-500 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-blob"
          style={{
            animation: "blob 7s infinite"
          }}
        ></div>
        <div 
          className="absolute bottom-0 left-0 w-96 h-96 bg-cyan-500 rounded-full mix-blend-screen filter blur-3xl opacity-15 animate-blob"
          style={{
            animation: "blob 7s infinite 2s"
          }}
        ></div>
        <div 
          className="absolute top-1/2 left-1/2 w-80 h-80 bg-purple-500 rounded-full mix-blend-screen filter blur-3xl opacity-10 animate-blob"
          style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              {/* Badge */}
              <div className="inline-block px-4 py-2 bg-blue-950 bg-opacity-60 text-blue-200 rounded-full text-sm font-semibold border border-blue-800 border-opacity-70 backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a
                href="#contact"
                className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-500 transition-all duration-300 font-semibold group shadow-lg shadow-blue-600/50 hover:shadow-blue-600/70"
              >
                Let's Connect
            ...
            <div className="flex gap-4 pt-4">
              <a
                ...
                className="inline-flex items-center justify-center w-12 h-12 bg-slate-800 bg-opacity-50 text-slate-300 rounded-lg hover:bg-blue-600 hover:text-white transition-all duration-300 border border-slate-700 backdrop-blur-sm"
              >
